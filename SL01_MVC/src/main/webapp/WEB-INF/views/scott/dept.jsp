...
<script type="text/javascript">
   $(function() {
      ...
      $("body").on("click", function(event) {
         // 모달창 외부를 클릭했을 때만 닫기
         if (!$(event.target).closest(addModal).length && addModal.is(":visible")) {
            addModal.css("display", "none");
         }
      });
      
      // 모달창 안에 확인 버튼 클릭 시 부서 추가
            ...
            if (result === "SUCCESS") {
               ...
               $(tr).appendTo($("table tbody"))
                  ...
                  .on("click", function(event) {
					...
					/*나: deptno = $(this).data("deptno")
                     removeTr = $(this).closest('tr')
                     //alert(deptno)
                     const dept = {
                        deptno:deptno
                     };
