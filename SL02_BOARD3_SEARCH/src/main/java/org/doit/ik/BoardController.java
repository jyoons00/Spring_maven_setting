...
public class BoardController {
	...
	*/
	...
	public String modify(BoardVO boardVO, RedirectAttributes rttr
		...
		/* // 뒤에 파라미터 붙이게 하기 위해 만들어진 것이다.
		rttr.addAttribute("pageNum",criteria.getPageNum()); // 일회성 아님
		rttr.addAttribute("amount",criteria.getAmount()); // 일회성 아님		
		rttr.addAttribute("type",criteria.getType()); // 일회성 아님
		rttr.addAttribute("keyword",criteria.getKeyword()); // 일회성 아님		
		*/
...
//		return String.format("redirect:/board/get?bno=%d", boardVO.getBno());
	     ...
	     return String.format("redirect:/board/get?bno=%s", params, boardVO.getBno());
